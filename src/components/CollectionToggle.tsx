  ...
  return (
    <div className={className} data-no-flip>
      <button
        ...
        className="cyber flex w-full items-center justify-between rounded-[var(--r-md)] border border-gold-700/40 bg-gold-500/10 px-3 py-2.5 text-xs font-bold text-gold-300"
      >
