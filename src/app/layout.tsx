...
const themeInit = `(function(){try{var mg={apple:"lux",dreamy:"cozy",studio:"game"};var ok=["cozy","game","lux"];var t=localStorage.getItem("lw_theme");t=mg[t]||t;if(ok.indexOf(t)<0)t="game";document.documentElement.setAttribute("data-theme",t);var m={game:"#040710",cozy:"#f8eedd",lux:"#0a1712"};var el=document.querySelector('meta[name="theme-color"]');if(el)el.setAttribute("content",m[t]);}catch(e){document.documentElement.setAttribute("data-theme","game")}})()`;
